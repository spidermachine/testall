...
def main(unused_argv):
    ...
    mnist_classifier = tf.estimator.Estimator(
        model_fn=cnn_model_fn, model_dir="32_convnet_model")
    ...
    mnist_classifier.train(
        input_fn=get_train_dataset('template_7'),
        steps=20000,
        hooks=[logging_hook])

    # Evaluate the model and print results
    eval_results = mnist_classifier.evaluate(input_fn=get_train_dataset('template_7'))
    print(eval_results)
